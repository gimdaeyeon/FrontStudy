...
export default function ResetPasswordPage() {
  ...
  return (
    <div className="flex flex-col gap-8">
      ...
      <Input disabled={isUpdatePasswordPending} value={password} onChange={e => setPassword(e.target.value)} type="password" className="py-6"
             placeholder="password"/>
      <Button onClick={handleUpdatePasswordClick} disabled={isUpdatePasswordPending} className="w-full">비밀번호 변경하기</Button>
    </div>
  );
